 ...
 * <ul>
 *   <li>{@link ccmm.impl.ContactsImpl#getContact <em>Contact</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContactsImpl extends MinimalEObjectImpl.Container implements Contacts {
	...
	protected EClass eStaticClass() {
		return CcmmPackage.Literals.CONTACTS;
	}
	...
	public EList<Contact> getContact() {
		if (contact == null) {
			contact = new EObjectContainmentEList<Contact>(Contact.class, this, CcmmPackage.CONTACTS__CONTACT);
		}
		return contact;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CcmmPackage.CONTACTS__CONTACT:
