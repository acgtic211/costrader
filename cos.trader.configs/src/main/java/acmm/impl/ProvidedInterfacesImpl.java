 ...
 * <ul>
 *   <li>{@link acmm.impl.ProvidedInterfacesImpl#getInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProvidedInterfacesImpl extends MinimalEObjectImpl.Container implements ProvidedInterfaces {
	...
	protected EClass eStaticClass() {
		return AcmmPackage.Literals.PROVIDED_INTERFACES;
	}
	...
	public EList<ProvidedInterface> getInterface() {
		if (interface_ == null) {
			interface_ = new EObjectContainmentEList<ProvidedInterface>(ProvidedInterface.class, this, AcmmPackage.PROVIDED_INTERFACES__INTERFACE);
		}
		return interface_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AcmmPackage.PROVIDED_INTERFACES__INTERFACE:
