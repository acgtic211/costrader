 ...
 * <ul>
 *   <li>{@link acmm.impl.DependenciesImpl#getDependency <em>Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesImpl extends MinimalEObjectImpl.Container implements Dependencies {
	...
	protected EClass eStaticClass() {
		return AcmmPackage.Literals.DEPENDENCIES;
	}
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, AcmmPackage.DEPENDENCIES__DEPENDENCY);
		}
		return dependency;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AcmmPackage.DEPENDENCIES__DEPENDENCY:
