 ...
 * <ul>
 *   <li>{@link acmm.impl.InterfaceImpl#getInterfaceID <em>Interface ID</em>}</li>
 *   <li>{@link acmm.impl.InterfaceImpl#getInterfaceDescription <em>Interface Description</em>}</li>
 *   <li>{@link acmm.impl.InterfaceImpl#getInterfaceSpecification <em>Interface Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
	...
	protected EClass eStaticClass() {
		return AcmmPackage.Literals.INTERFACE;
	}
	...
	public void setInterfaceID(String newInterfaceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcmmPackage.INTERFACE__INTERFACE_ID, oldInterfaceID, interfaceID));
	}
	...
	public void setInterfaceDescription(String newInterfaceDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcmmPackage.INTERFACE__INTERFACE_DESCRIPTION, oldInterfaceDescription, interfaceDescription));
	}
	...
	public NotificationChain basicSetInterfaceSpecification(WSDLSpecification newInterfaceSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AcmmPackage.INTERFACE__INTERFACE_SPECIFICATION, oldInterfaceSpecification, newInterfaceSpecification);
	...
	public void setInterfaceSpecification(WSDLSpecification newInterfaceSpecification) {
		if (newInterfaceSpecification != interfaceSpecification) {
			...
			if (interfaceSpecification != null)
				msgs = ((InternalEObject)interfaceSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AcmmPackage.INTERFACE__INTERFACE_SPECIFICATION, null, msgs);
			if (newInterfaceSpecification != null)
				msgs = ((InternalEObject)newInterfaceSpecification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AcmmPackage.INTERFACE__INTERFACE_SPECIFICATION, null, msgs);
			msgs = basicSetInterfaceSpecification(newInterfaceSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AcmmPackage.INTERFACE__INTERFACE_SPECIFICATION, newInterfaceSpecification, newInterfaceSpecification));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AcmmPackage.INTERFACE__INTERFACE_SPECIFICATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AcmmPackage.INTERFACE__INTERFACE_ID:
				return getInterfaceID();
			case AcmmPackage.INTERFACE__INTERFACE_DESCRIPTION:
