 ...
 * <ul>
 *   <li>{@link ccmm.impl.RequiredInterfacesImpl#getInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequiredInterfacesImpl extends MinimalEObjectImpl.Container implements RequiredInterfaces {
	...
	protected EClass eStaticClass() {
		return CcmmPackage.Literals.REQUIRED_INTERFACES;
	}
	...
	public EList<RequiredInterface> getInterface() {
		if (interface_ == null) {
			interface_ = new EObjectContainmentEList<RequiredInterface>(RequiredInterface.class, this, CcmmPackage.REQUIRED_INTERFACES__INTERFACE);
		}
		return interface_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CcmmPackage.REQUIRED_INTERFACES__INTERFACE:
