 ...
 * <ul>
 *   <li>{@link ccmm.impl.DependenciesImpl#getDependency <em>Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesImpl extends MinimalEObjectImpl.Container implements Dependencies {
	...
	protected EClass eStaticClass() {
		return CcmmPackage.Literals.DEPENDENCIES;
	}
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, CcmmPackage.DEPENDENCIES__DEPENDENCY);
		}
		return dependency;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CcmmPackage.DEPENDENCIES__DEPENDENCY:
