 ...
 * <ul>
 *   <li>{@link ccmm.RequiredInterfaces#getInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @see ccmm.CcmmPackage#getRequiredInterfaces()
 * @model
 * @generated
 */
public interface RequiredInterfaces extends EObject {
	 ...
	 * @see ccmm.CcmmPackage#getRequiredInterfaces_Interface()
