 ...
 * @generated
 */
public class AcmmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AcmmPackage.ABSTRACT_COMPONENT_SPECIFICATION: {
				AbstractComponentSpecification abstractComponentSpecification = (AbstractComponentSpecification)theEObject;
				T result = caseAbstractComponentSpecification(abstractComponentSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.CONTACT: {
				Contact contact = (Contact)theEObject;
				T result = caseContact(contact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.CONTACTS: {
				Contacts contacts = (Contacts)theEObject;
				T result = caseContacts(contacts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.FUNCTIONAL: {
				Functional functional = (Functional)theEObject;
				T result = caseFunctional(functional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.IMPLEMENTATION: {
				Implementation implementation = (Implementation)theEObject;
				T result = caseImplementation(implementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.MARKETING: {
				Marketing marketing = (Marketing)theEObject;
				T result = caseMarketing(marketing);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.INTERFACE: {
				Interface interface_ = (Interface)theEObject;
				T result = caseInterface(interface_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcmmPackage.PROVIDED_INTERFACE: {
			...
			case AcmmPackage.REQUIRED_INTERFACE: {
			...
			case AcmmPackage.OUTPUT_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Component Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Component Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractComponentSpecification(AbstractComponentSpecification object) {
		return null;
	}
